...
int main()
{
	...
	// 3D obj
	Shader objShader(SHADER_PATH("09_geometry_exploding.vs")
		, SHADER_PATH("09_geometry_exploding.fs")
		, SHADER_PATH("09_geometry_exploding.gs"));
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// ------------------------------
		{
			...
			objShader.setFloat("time", glfwGetTime());
